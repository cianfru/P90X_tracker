"""
Database schema (PostgreSQL), embedded as a string.

Kept in Python rather than a .sql file so serverless deployments can't fail on
a missing bundled asset — the DDL always ships with the code. It is idempotent
(CREATE ... IF NOT EXISTS / ADD COLUMN IF NOT EXISTS) and runs once per warm
